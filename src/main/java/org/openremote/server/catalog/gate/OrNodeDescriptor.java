...
public class OrNodeDescriptor extends NodeDescriptor {

    public static final String TYPE = "urn:openremote:flow:node:or";
    public static final String TYPE_LABEL = "OR";
    ...
    public NodeRoute createRoute(CamelContext context, Flow flow, Node node) {
        return new OrRoute(context, flow, node);
    }
