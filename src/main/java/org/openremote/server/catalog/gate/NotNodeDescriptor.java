...
public class NotNodeDescriptor extends NodeDescriptor {

    public static final String TYPE = "urn:openremote:flow:node:not";
    public static final String TYPE_LABEL = "NOT";
    ...
    public NodeRoute createRoute(CamelContext context, Flow flow, Node node) {
        return new NotRoute(context, flow, node);
    }
